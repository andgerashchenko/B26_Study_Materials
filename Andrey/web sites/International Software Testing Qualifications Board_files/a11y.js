...
function MicAccessTool(o) {
  (this.init = o || {
    ...
    this.micToolboxFontsSimple.addEventListener('click', this.onceButtonChangeReadPage),
    ...
    (this.micToolboxBigCursor = document.getElementById('mic-toolbox-big-cursor')),
...
(MicAccessTool.prototype.checkLanguageBox = function () {
  ...
  (MicAccessTool.prototype.buildToolBox = function () {
    var o = this.currentLanguage || this.locale.en,
      A =
        ...
        o.zoom_block.btn_cursor_black +
        '</span></button>' +
        '</div><div class="link-access-page"><a class="atb-hide-if-empty" title="' +
  ...
  (MicAccessTool.prototype.keyboardRootEnable = function () {
    if (window.MICTOOLBOXAPPSTATE.keyboardRoot)
      for (
        var o = document.querySelectorAll('h1,h2,h3,h4,h5,h6,p,a,button,input,select,textarea'),
          A = 0;
        A < o.length;
        A++
      ) {
  ...
  (MicAccessTool.prototype.fontsChange = function (o) {
    ...
    if ('mic-toolbox-fonts-up' === this.id) {
      ...
      for (
        var t = document.querySelectorAll(
            'html,body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div'
          ),
          i = 0;
        i < t.length;
        i++
    ...
    if ('mic-toolbox-fonts-down' === this.id) {
      if (A <= 1)
        return (window.MICTOOLBOXAPPSTATE.fontSize = 1), void MicAccessTool.prototype.updateState();
      for (
